...
const experiences = [
  {
    ...
    desc: "Developing full stack web applications using Next.js, TypeScript, MongoDB and modern frontend technologies with focus on performance and user experience.",
  },
  {
    year: "2025",
    role: "Hackathon Participant",
    company: "SIH & Beast Mode",
    desc: "Participated in national-level hackathons, worked on problem solving, team collaboration and rapid product development.",
  },
  {
    year: "2024",
    role: "Computer Science Student",
    company: "BKBIET Pilani",
    desc: "Focused on Data Structures & Algorithms, Web Development, DBMS, Operating Systems and Software Engineering fundamentals.",
  },
];
