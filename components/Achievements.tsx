...
export default function Achievements() {
  return (
    <section id="achievements" className="relative z-10 px-6 py-32">
      <motion.h2
      ...
      <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-3">
        {achievements.map((item, index) => (
          <motion.div
            ...
            className="group relative overflow-hidden rounded-[35px] border border-white/10 bg-white/5 p-8 backdrop-blur-xl transition-all duration-500 hover:border-cyan-400/30"
          >
